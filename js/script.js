...
var translations = {
  pt: {
    ...
    "proj3Cat":      "Branding · KV · Identidade Visual",
    "proj3Desc":     "Projeto de marca completo para imobiliária com mais de 35 anos de mercado. Inclui redesign de logo, arquétipo de marca, moodboard, paleta, tipografia e padrão visual de posts para redes sociais.",
    "proj3Link":     "Projeto Confidencial",
    "proj4Cat":      "Landing Page · Web Design · E-commerce",
    "proj4Desc":     "Landing page para fabricante de sacolas personalizadas em TNT. Design limpo e sustentável com foco em conversão para solicitação de orçamento. Desenvolvida com v0 + Vercel.",
  ...
  en: {
    ...
    "proj3Cat":      "Branding · KV · Visual Identity",
    "proj3Desc":     "Complete brand project for a real estate agency with 35+ years in the market. Includes logo redesign, brand archetype, moodboard, color palette, typography and social media posts template.",
    "proj3Link":     "Confidential Project",
    "proj4Cat":      "Landing Page · Web Design · E-commerce",
    "proj4Desc":     "Landing page for a custom TNT bag manufacturer. Clean, sustainable design focused on quote conversion. Built with v0 + Vercel.",
