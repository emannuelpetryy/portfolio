...
var translations = {
  pt: {
    ...
    "exp1Desc":      "Criação de campanhas visuais de tráfego pago (Ad Creatives) para Feed e Stories, identidades visuais de campanhas e peças publicitárias para clientes corporativos de grande porte.",
    ...
    "exp3Desc":      "Desenvolvimento de landing pages de alta conversão, e-commerces (Shopify & Tray), sites institucionais e interfaces focadas em UX/UI, SEO e design responsivo.",
    // Bottom
  ...
  en: {
    ...
    "exp1Desc":      "Created high-converting ad campaigns (Ad Creatives) for Feed and Stories, campaign visual identities, and advertising materials for major corporate accounts.",
    "exp2Co":        "Agronavis / EEmovel Agro",
    ...
    "exp3Co":        "Staker",
    "exp3Role":      "Web Designer & UI/UX",
    "exp3Desc":      "Developed high-converting landing pages, e-commerce stores (Shopify & Tray), institutional websites, and interfaces focusing on UX/UI and SEO.",
    // Bottom
