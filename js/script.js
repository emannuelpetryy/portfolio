...
var translations = {
  pt: {
    ...
    // Selected Projects
    "proj1Cat":      "Web Design · Branding · UI",
    "proj1Desc":     "Landing page completa para complexo esportivo em Cascavel/PR. Visual dark com tipografia bold e verde neon, otimizada para conversão via WhatsApp. Inclui área do mensalista e sistema de reservas.",
    "proj1Link":     "Ver projeto →",
    "proj2Cat":      "SaaS · UI Design · Product Design",
    "proj2Desc":     "Sistema CRM completo para vendas consultivas. Pipeline com roteiro de call assistido por IA, kanban de leads, dashboard de performance e prospecção com dados da Receita Federal.",
    "proj2Link":     "Ver projeto →",
    "proj3Cat":      "SaaS · Inteligência de Dados · CRM",
    "proj3Desc":     "Plataforma SaaS de inteligência de dados B2B com base de 30M+ de empresas, CRM Kanban para vendas externas, motor de IA entrevistadora e prospecção ativa em campo.",
    "proj3Link":     "Plataforma SaaS",
    "proj4Cat":      "Landing Page · Agronegócio · Web Design",
    "proj4Desc":     "Landing page premium de alta conversão para produtor agrícola de sementes e feno em altitude (SC). Visual verde e dourado com curvas orgânicas de colina em SVG e fluxo de cotação via WhatsApp.",
    "proj4Link":     "Ver projeto →",
    "proj5Cat":      "E-commerce · Shopify · Branding · Web Design",
    "proj5Desc":     "Loja virtual e marca de vestuário/lifestyle (\"AAMU | Em todos os movimentos\") desenvolvida em Shopify. Design minimalista com foco na experiência do usuário e alta conversão.",
    "proj5Link":     "Ver projeto →",
    "proj6Cat":      "Branding · KV · Identidade Visual",
    "proj6Desc":     "Projeto de marca completo para imobiliária com mais de 35 anos de mercado. Inclui redesign de logo, arquétipo de marca, moodboard, paleta, tipografia e padrão visual de posts para redes sociais.",
    "proj6Link":     "Projeto Confidencial",
    "proj7Cat":      "Landing Page · Web Design · E-commerce",
    "proj7Desc":     "Landing page para fabricante de sacolas personalizadas em TNT. Design limpo e sustentável com foco em conversão para solicitação de orçamento. Desenvolvida com v0 + Vercel.",
    "proj7Link":     "Ver projeto →",
    // Experience
    "exp1Co":        "V4 Company",
  ...
  en: {
    ...
    // Selected Projects
    "proj1Cat":      "Web Design · Branding · UI",
    "proj1Desc":     "Complete landing page for a sports complex in Cascavel, Brazil. Dark visual with bold typography and neon green, optimized for WhatsApp conversion.",
    "proj1Link":     "View project →",
    "proj2Cat":      "SaaS · UI Design · Product Design",
    "proj2Desc":     "Full CRM system for consultative sales. AI-assisted call pipeline, lead kanban, performance dashboard and prospecting with official business data.",
    "proj2Link":     "View project →",
    "proj3Cat":      "SaaS · Data Intelligence · CRM",
    "proj3Desc":     "B2B data intelligence SaaS platform featuring 30M+ company records, field-sales Kanban CRM, AI-driven interviewing engine and active prospecting.",
    "proj3Link":     "SaaS Platform",
    "proj4Cat":      "Landing Page · Agribusiness · Web Design",
    "proj4Desc":     "High-converting premium landing page for high-altitude seed and hay agricultural producer in Santa Catarina. Green and gold visuals with organic SVG hill curves and WhatsApp quotation flow.",
    "proj4Link":     "View project →",
    "proj5Cat":      "E-commerce · Shopify · Branding · Web Design",
    "proj5Desc":     "Full online store and visual identity for lifestyle/activewear brand (\"AAMU | In all movements\") built on Shopify. Minimalist design focused on user experience and conversion.",
    "proj5Link":     "View project →",
    "proj6Cat":      "Branding · KV · Visual Identity",
    "proj6Desc":     "Complete brand project for a real estate agency with 35+ years in the market. Includes logo redesign, brand archetype, moodboard, color palette, typography and social media posts template.",
    "proj6Link":     "Confidential Project",
    "proj7Cat":      "Landing Page · Web Design · E-commerce",
    "proj7Desc":     "Landing page for a custom TNT bag manufacturer. Clean, sustainable design focused on quote conversion. Built with v0 + Vercel.",
    "proj7Link":     "View project →",
    // Experience
    "exp1Co":        "V4 Company",
...
var domMap = [
  ...
  ["proj5Cat",    "#proj5Cat",         "text"],
  ["proj5Desc",   "#proj5Desc",        "text"],
  ["proj5Link",   "#proj5Link",        "text"],

  ["proj6Cat",    "#proj6Cat",         "text"],
  ["proj6Desc",   "#proj6Desc",        "text"],
  ["proj6Link",   "#proj6Link",        "text"],

  ["proj7Cat",    "#proj7Cat",         "text"],
  ["proj7Desc",   "#proj7Desc",        "text"],
  ["proj7Link",   "#proj7Link",        "text"],
