...
var translations = {
  pt: {
    ...
    // Experience
    "exp1Co":        "V4 Company",
    "exp1Role":      "Designer Gráfico & Estruturação",
    "exp1Desc":      "Estruturação de marketing estratégico para marcas como Lojas Roth (ecossistema digital, jornada e posicionamento), além da criação de campanhas de tráfego pago (Ad Creatives) com I.A. Generativa.",
    "exp2Co":        "Agronavis / EEmovel Agro",
    "exp2Role":      "Designer Gráfico",
    "exp2Desc":      "Produção de peças digitais, materiais impressos e comunicação institucional direcionados ao agronegócio, fortalecendo a autoridade e clareza da marca.",
    "exp3Co":        "Staker",
    "exp3Role":      "Web Designer & UI/UX",
    "exp3Desc":      "Criação visual completa e gestão de e-commerce para a marca Classe Couro, além de desenvolvimento em WordPress (Elementor Pro), Shopify, Tray e otimização de conversão.",
    // Bottom
  ...
  en: {
    ...
    // Experience
    "exp1Co":        "V4 Company",
    "exp1Role":      "Graphic Designer & Structuring",
    "exp1Desc":      "Strategic marketing structuring for retail brands such as Lojas Roth (digital ecosystem, customer journey and visual positioning), plus AI-driven ad creative campaigns.",
    "exp2Co":        "Agronavis / EEmovel Agro",
    "exp2Role":      "Graphic Designer",
    "exp2Desc":      "Produced digital and print materials for marketing campaigns, social media, and institutional communication in the agribusiness sector.",
    "exp3Co":        "Staker",
    "exp3Role":      "Web Designer & UI/UX",
    "exp3Desc":      "Complete visual creation of the brand and e-commerce operation management for Classe Couro, plus web development in WordPress (Elementor Pro), Shopify and Tray.",
    // Bottom
